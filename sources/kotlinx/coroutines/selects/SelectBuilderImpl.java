            ...
            if (obj4 == obj) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                    if (Result.m376isFailureimpl(result)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable m373exceptionOrNullimpl = Result.m373exceptionOrNullimpl(result);
                        Intrinsics.checkNotNull(m373exceptionOrNullimpl);
                        Result.Companion companion = Result.INSTANCE;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            m373exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m373exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m370constructorimpl(ResultKt.createFailure(m373exceptionOrNullimpl)));
                        return;
                    }
        ...
        while (true) {
            ...
            if (obj4 == obj) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    intercepted.resumeWith(Result.m370constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            } else {
                throw new IllegalStateException("Already resumed");
