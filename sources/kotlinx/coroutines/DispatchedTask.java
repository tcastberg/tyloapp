    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                        ...
                        continuation.resumeWith(Result.m370constructorimpl(ResultKt.createFailure(cancellationException)));
                    }
                    ...
                    continuation.resumeWith(Result.m370constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
                }
                ...
                try {
                    ...
                    m370constructorimpl2 = Result.m370constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    m370constructorimpl2 = Result.m370constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m373exceptionOrNullimpl(m370constructorimpl2));
            } finally {
            ...
            try {
                ...
                m370constructorimpl = Result.m370constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m373exceptionOrNullimpl(m370constructorimpl));
        }
    }
