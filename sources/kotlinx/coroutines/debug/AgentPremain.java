...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m370constructorimpl = Result.m370constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m370constructorimpl = Result.m370constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m376isFailureimpl(m370constructorimpl) ? null : m370constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1898installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1898installSignalHandler$lambda1(Signal signal) {
