...
public class LockFreeLinkedListNode {
    ...
    public final LockFreeLinkedListNode removeFirstOrNull() {
        while (true) {
            ...
            if (lockFreeLinkedListNode.mo1920remove()) {
        ...
        */
        public final java.lang.Object prepare(kotlinx.coroutines.internal.AtomicOp<?> r7) {
            ...
            L33:
                ...
                if (r4 == r5) goto L0
                boolean r6 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch: java.lang.Throwable -> L61
                if (r6 == 0) goto L60
                if (r4 != 0) goto L5a
                goto L60
            L5a:
