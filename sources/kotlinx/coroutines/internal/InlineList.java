...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m1910boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m1911constructorimpl(Object obj) {
        return obj;
    }
    ...
    public boolean equals(Object obj) {
        return m1913equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1916hashCodeimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1912constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1911constructorimpl(obj);
    }

    /* renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m1917plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m1911constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m1911constructorimpl(arrayList);
    }

    /* renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m1915forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
