...
public interface SendChannel<E> {
    ...
    Object mo1875trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1875trySendJP2dKIU = sendChannel.mo1875trySendJP2dKIU(e);
            if (ChannelResult.m1890isSuccessimpl(mo1875trySendJP2dKIU)) {
                return true;
            }
            Throwable m1884exceptionOrNullimpl = ChannelResult.m1884exceptionOrNullimpl(mo1875trySendJP2dKIU);
