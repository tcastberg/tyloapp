...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo1873receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            java.lang.Object r4 = r4.m1893closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r4 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            java.lang.Object r4 = r4.m1895successJP2dKIU(r5)
        L52:
            return r4
        L53:
            r0.label = r3
        ...
        L5c:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1873receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public final Object mo1874tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1894failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.INSTANCE.m1893closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.INSTANCE.m1895successJP2dKIU(pollInternal);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object m1912constructorimpl$default = InlineList.m1912constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo1920remove()) {
                    prevNode.helpRemove();
                } else {
                    m1912constructorimpl$default = InlineList.m1917plusFjFbRPM(m1912constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1872onCancelIdempotentListww6eGU(m1912constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            if (i == 1) {
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1880boximpl(z ? ChannelResult.INSTANCE.m1893closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.INSTANCE.m1895successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            } else {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1880boximpl(ChannelResult.INSTANCE.m1893closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1880boximpl(ChannelResult.INSTANCE.m1895successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                ChannelResult m1880boximpl = ChannelResult.m1880boximpl(ChannelResult.INSTANCE.m1893closedJP2dKIU(closed.closeCause));
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m370constructorimpl(m1880boximpl));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E value) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1880boximpl(ChannelResult.INSTANCE.m1895successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1880boximpl(ChannelResult.INSTANCE.m1893closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo1872onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
