...
public final class ContentType implements Serializable {
    ...
    static {
        ...
        ContentType create7 = create("multipart/form-data", Consts.ISO_8859_1);
        MULTIPART_FORM_DATA = create7;
        ContentType create8 = create("text/html", Consts.ISO_8859_1);
        TEXT_HTML = create8;
        ContentType create9 = create(HTTP.PLAIN_TEXT_TYPE, Consts.ISO_8859_1);
        TEXT_PLAIN = create9;
        ContentType create10 = create("text/xml", Consts.ISO_8859_1);
        TEXT_XML = create10;
        WILDCARD = create("*/*", (Charset) null);
        ContentType[] contentTypeArr = {create, create2, create3, create4, create5, create6, create7, create8, create9, create10};
