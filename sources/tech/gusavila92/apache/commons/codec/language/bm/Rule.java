...
public class Rule {
    ...
    public static final RPattern ALL_STRINGS_RMATCHER = new RPattern() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.1
        @Override // tech.gusavila92.apache.commons.codec.language.bm.Rule.RPattern
    ...
    public static final class Phoneme implements PhonemeExpr {
        public static final Comparator<Phoneme> COMPARATOR = new Comparator<Phoneme>() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.Phoneme.1
        ...
        @Override // tech.gusavila92.apache.commons.codec.language.bm.Rule.PhonemeExpr
            ...
            if (i4 != 0) {
                ...
                if (trim.length() == 0) {
                    ...
                    try {
                        ...
                        str2 = "' in ";
                        try {
                            Rule rule = new Rule(stripQuotes, stripQuotes2, stripQuotes3, parsePhonemeExpr(stripQuotes(split[3])), i5, str, stripQuotes, stripQuotes2, stripQuotes3) { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.2
    ...
    private static RPattern pattern(String str) {
        ...
        if (substring.contains("[")) {
            ...
            if (startsWith2 && endsWith2) {
                ...
                if (!substring2.contains("[")) {
                    ...
                    if (startsWith && endsWith) {
                        return new RPattern() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.7
                            @Override // tech.gusavila92.apache.commons.codec.language.bm.Rule.RPattern
                            public boolean isMatch(CharSequence charSequence) {
                    ...
                    if (startsWith) {
                        return new RPattern() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.8
                            @Override // tech.gusavila92.apache.commons.codec.language.bm.Rule.RPattern
                            public boolean isMatch(CharSequence charSequence) {
                    ...
                    if (endsWith) {
                        return new RPattern() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.9
                            @Override // tech.gusavila92.apache.commons.codec.language.bm.Rule.RPattern
                            public boolean isMatch(CharSequence charSequence) {
            ...
            if (startsWith && endsWith) {
                if (substring.length() == 0) {
                    return new RPattern() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.3
                        @Override // tech.gusavila92.apache.commons.codec.language.bm.Rule.RPattern
                        public boolean isMatch(CharSequence charSequence) {
                ...
                return new RPattern() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.4
                    @Override // tech.gusavila92.apache.commons.codec.language.bm.Rule.RPattern
                    public boolean isMatch(CharSequence charSequence) {
            ...
            if (startsWith) {
                return new RPattern() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.5
                    @Override // tech.gusavila92.apache.commons.codec.language.bm.Rule.RPattern
                    public boolean isMatch(CharSequence charSequence) {
            ...
            if (endsWith) {
                return new RPattern() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.6
                    @Override // tech.gusavila92.apache.commons.codec.language.bm.Rule.RPattern
                    public boolean isMatch(CharSequence charSequence) {
        ...
        return new RPattern(str) { // from class: tech.gusavila92.apache.commons.codec.language.bm.Rule.10
            Pattern pattern;
