...
public class Languages {
    ...
    public static final class SomeLanguages extends LanguageSet {
        ...
        @Override // tech.gusavila92.apache.commons.codec.language.bm.Languages.LanguageSet
    ...
    static {
        ...
        NO_LANGUAGES = new LanguageSet() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Languages.1
            @Override // tech.gusavila92.apache.commons.codec.language.bm.Languages.LanguageSet
            public boolean contains(String str) {
                return false;
            }
        ...
        ANY_LANGUAGE = new LanguageSet() { // from class: tech.gusavila92.apache.commons.codec.language.bm.Languages.2
            @Override // tech.gusavila92.apache.commons.codec.language.bm.Languages.LanguageSet
            public boolean contains(String str) {
                return true;
            }
