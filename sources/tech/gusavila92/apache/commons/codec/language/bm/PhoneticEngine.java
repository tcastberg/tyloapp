...
public class PhoneticEngine {
    ...
    public String encode(String str, Languages.LanguageSet languageSet) {
        ...
        int i = AnonymousClass1.$SwitchMap$tech$gusavila92$apache$commons$codec$language$bm$NameType[this.nameType.ordinal()];
        if (i == 1) {
    ...
    /* renamed from: tech.gusavila92.apache.commons.codec.language.bm.PhoneticEngine$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$tech$gusavila92$apache$commons$codec$language$bm$NameType;

        static {
            int[] iArr = new int[NameType.values().length];
            $SwitchMap$tech$gusavila92$apache$commons$codec$language$bm$NameType = iArr;
            try {
                iArr[NameType.SEPHARDIC.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$tech$gusavila92$apache$commons$codec$language$bm$NameType[NameType.ASHKENAZI.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$tech$gusavila92$apache$commons$codec$language$bm$NameType[NameType.GENERIC.ordinal()] = 3;
