...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.setARGB(255, UserSetting.User_setting.language_t.LANG_SWEDISH_VALUE, UserSetting.User_setting.language_t.LANG_SWEDISH_VALUE, UserSetting.User_setting.language_t.LANG_SWEDISH_VALUE);
