...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle m53lambda$attachController$4$androidxfragmentappFragmentManager = this.mChildFragmentManager.m53lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m53lambda$attachController$4$androidxfragmentappFragmentManager != null) {
            bundle.putParcelable("android:support:fragments", m53lambda$attachController$4$androidxfragmentappFragmentManager);
        }
    }
