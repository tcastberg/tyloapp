...
public final class WindowMetricsCalculatorCompat implements WindowMetricsCalculator {
    ...
    public WindowMetrics computeCurrentWindowMetrics(Activity activity) {
        Rect computeWindowBoundsQ$window_release;
        Intrinsics.checkNotNullParameter(activity, "activity");
        if (Build.VERSION.SDK_INT >= 30) {
            computeWindowBoundsQ$window_release = ActivityCompatHelperApi30.INSTANCE.currentWindowBounds(activity);
        } else {
            computeWindowBoundsQ$window_release = computeWindowBoundsQ$window_release(activity);
        }
        return new WindowMetrics(computeWindowBoundsQ$window_release);
    }
