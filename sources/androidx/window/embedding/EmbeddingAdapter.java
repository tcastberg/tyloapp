...
public final class EmbeddingAdapter {
    ...
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda2
            ...
            public final boolean test(Object obj) {
                boolean m95translateActivityPairPredicates$lambda1;
                m95translateActivityPairPredicates$lambda1 = EmbeddingAdapter.m95translateActivityPairPredicates$lambda1(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m95translateActivityPairPredicates$lambda1;
            }
        };
    }
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m94translateActivityIntentPredicates$lambda3;
                m94translateActivityIntentPredicates$lambda3 = EmbeddingAdapter.m94translateActivityIntentPredicates$lambda3(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m94translateActivityIntentPredicates$lambda3;
            }
        };
    }
    ...
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(final SplitRule splitRule) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m98translateParentMetricsPredicate$lambda4;
                m98translateParentMetricsPredicate$lambda4 = EmbeddingAdapter.m98translateParentMetricsPredicate$lambda4(SplitRule.this, (WindowMetrics) obj);
                return m98translateParentMetricsPredicate$lambda4;
            }
        };
    }
    ...
    public final Predicate<Activity> translateActivityPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda4
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m96translateActivityPredicates$lambda6;
                m96translateActivityPredicates$lambda6 = EmbeddingAdapter.m96translateActivityPredicates$lambda6(activityFilters, (Activity) obj);
                return m96translateActivityPredicates$lambda6;
            }
        };
    }
    ...
    public final Predicate<Intent> translateIntentPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m97translateIntentPredicates$lambda8;
                m97translateIntentPredicates$lambda8 = EmbeddingAdapter.m97translateIntentPredicates$lambda8(activityFilters, (Intent) obj);
                return m97translateIntentPredicates$lambda8;
            }
        };
    }
