                ...
                try {
                    if (query.getCount() > 0) {
                        ...
                        while (query.moveToNext()) {
                            ...
                            arrayList.add(FontsContractCompat.FontInfo.create(withAppendedId, i2, columnIndex5 != -1 ? query.getInt(columnIndex5) : HttpStatus.SC_BAD_REQUEST, columnIndex6 != -1 && query.getInt(columnIndex6) == 1, i));
                        }
                    }
                } catch (Throwable th) {
                    th = th;
