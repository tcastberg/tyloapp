...
public final class NavGraphViewModelLazyKt {
    ...
    public static final NavBackStackEntry m73navGraphViewModels$lambda0(Lazy<NavBackStackEntry> lazy) {
    ...
    public static final NavBackStackEntry m74navGraphViewModels$lambda1(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
    ...
    public static final NavBackStackEntry m75navGraphViewModels$lambda2(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
    ...
    public static final NavBackStackEntry m76navGraphViewModels$lambda3(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
}
