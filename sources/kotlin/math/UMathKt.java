...
public final class UMathKt {
    ...
    private static final int m1593minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1575minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1594mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1583minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1591maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1563maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1592maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1571maxOfeb3DHEI(j, j2);
    }
}
