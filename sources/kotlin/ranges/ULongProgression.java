...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1589getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m544constructorimpl = ((int) ULong.m544constructorimpl(j ^ ULong.m544constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m544constructorimpl2 = (m544constructorimpl + ((int) ULong.m544constructorimpl(j2 ^ ULong.m544constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) ((j3 >>> 32) ^ j3)) + m544constructorimpl2;
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m590toStringimpl(this.first)).append("..").append((Object) ULong.m590toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m590toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m590toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1615fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
