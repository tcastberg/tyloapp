...
public final class DurationKt {
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m1798getZEROUwyO8pc = Duration.INSTANCE.m1798getZEROUwyO8pc();
        ...
        if (str2.charAt(i3) == 'P') {
            ...
            while (i4 < length) {
                if (str2.charAt(i4) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        z4 = z7;
                        long m1732plusLRDsOJo = Duration.m1732plusLRDsOJo(m1798getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                        m1798getZEROUwyO8pc = Duration.m1732plusLRDsOJo(m1732plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        z4 = z7;
                        m1798getZEROUwyO8pc = Duration.m1732plusLRDsOJo(m1798getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
                    z7 = z4;
            ...
            if (StringsKt.regionMatches(str, i3, "Infinity", 0, Math.max(length - i3, 8), true)) {
                m1798getZEROUwyO8pc = Duration.INSTANCE.m1796getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (i3 < i) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m1732plusLRDsOJo2 = Duration.m1732plusLRDsOJo(m1798getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "this as java.lang.String).substring(startIndex)");
                        m1798getZEROUwyO8pc = Duration.m1732plusLRDsOJo(m1732plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i3 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m1798getZEROUwyO8pc = Duration.m1732plusLRDsOJo(m1798getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m1748unaryMinusUwyO8pc(m1798getZEROUwyO8pc) : m1798getZEROUwyO8pc;
    }
    ...
    public static final long durationOf(long j, int i) {
        return Duration.m1696constructorimpl((j << 1) + i);
    }
