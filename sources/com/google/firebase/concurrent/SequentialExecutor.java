        ...
        */
        private void workOnQueue() {
            ...
            L2d:
                ...
                if (r3 != 0) goto L4f
                com.google.firebase.concurrent.SequentialExecutor r8 = com.google.firebase.concurrent.SequentialExecutor.this     // Catch: java.lang.Throwable -> L83
                com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r0 = com.google.firebase.concurrent.SequentialExecutor.WorkerRunningState.IDLE     // Catch: java.lang.Throwable -> L83
                com.google.firebase.concurrent.SequentialExecutor.access$202(r8, r0)     // Catch: java.lang.Throwable -> L83
                monitor-exit(r2)     // Catch: java.lang.Throwable -> L83
                if (r1 == 0) goto L4e
                java.lang.Thread r8 = java.lang.Thread.currentThread()
                r8.interrupt()
