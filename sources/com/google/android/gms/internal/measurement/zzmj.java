...
class zzmj extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i2 = 0;
        if (i >= 0) {
            int compareTo = comparable.compareTo(((zzmd) this.zzb.get(i)).zza());
            if (compareTo > 0) {
                return -(size + 1);
            }
            if (compareTo == 0) {
        ...
        while (i2 <= i) {
            int i3 = (i2 + i) / 2;
            int compareTo2 = comparable.compareTo(((zzmd) this.zzb.get(i3)).zza());
            if (compareTo2 < 0) {
                i = i3 - 1;
            } else {
                if (compareTo2 <= 0) {
    ...
    public final Object get(Object obj) {
        ...
        return zzk >= 0 ? ((zzmd) this.zzb.get(zzk)).getValue() : this.zzc.get(comparable);
    }
