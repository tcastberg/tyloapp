...
final class zzgl implements Callable {
    ...
    public final /* bridge */ /* synthetic */ Object call() throws Exception {
        ...
        if (!zzr.zzs.zzf().zzs(str2, zzeb.zzS)) {
        ...
        if (!"_iap".equals(zzawVar.zza) && !"_iapx".equals(zzawVar.zza)) {
            zzr.zzs.zzay().zzc().zzc("Generating a payload for this event is not available. package_name, event_name", str2, zzawVar.zza);
            return null;
        }
        com.google.android.gms.internal.measurement.zzfz zza = com.google.android.gms.internal.measurement.zzga.zza();
        zzr.zzf.zzi().zzw();
        try {
            zzh zzj = zzr.zzf.zzi().zzj(str2);
            if (zzj == null) {
                ...
                try {
                    ...
                    if (zzleVar == null || zzleVar.zze == null) {
                        zzle zzleVar2 = new zzle(zzt2, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_lte", zzr.zzs.zzav().currentTimeMillis(), 0L);
                        zzu.add(zzleVar2);
                    ...
                    if (zzu2.zzs.zzg().zze()) {
                        ...
                        if (zzj.zzah() && zzu2.zzf.zzo().zzn(zzt3)) {
                            ...
                            zzu.add(new zzle(zzt3, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_npa", zzu2.zzs.zzav().currentTimeMillis(), 1L));
                        }
                    }
                    ...
                    zzr.zzs.zzv().zzL(zzb.zzd, zzr.zzf.zzi().zzi(str2));
                    zzr.zzs.zzv().zzM(zzb, zzr.zzs.zzf().zzd(str2));
                    ...
                    zzas zzn = zzr.zzf.zzi().zzn(str2, zzawVar.zza);
                    if (zzn == null) {
                        zzgbVar = zzt;
                        zzhVar = zzj;
                        str = str2;
                        bundle = bundle2;
                        zzc = new zzas(str2, zzawVar.zza, 0L, 0L, 0L, zzawVar.zzd, 0L, null, null, null, null);
                        j = 0;
                    } else {
                        zzgbVar = zzt;
                        zzhVar = zzj;
                    ...
                    zzoz.zzc();
                    if (zzr.zzs.zzf().zzs(null, zzeb.zzar) && zzB != null) {
                        zzgbVar2.zzah(zzB);
                    }
                    zzhVar.zzE();
                    ...
                    if (zzr.zzs.zzf().zzs(null, zzeb.zzaz)) {
                    ...
                    zzr.zzf.zzi().zzC();
                    try {
                        return zzr.zzf.zzu().zzy(((com.google.android.gms.internal.measurement.zzga) zza.zzaE()).zzbv());
